...
+ 2. Generate sample
   ...
   ```
   Of course, you can download our pre-trained model from [Zenodo](https://zenodo.org/records/10784364). And put it in the corresponding `Train_log` directory. The training log can be found in the corresponding `Train_log` files.
